...
#$ -pe local 4
#$ -o /dcs04/lieber/lcolladotor/spatialHPC_LIBD4035/spatial_hpc/code/VistoSeg/code/logs/WS.$TASK_ID.txt
#$ -e /dcs04/lieber/lcolladotor/spatialHPC_LIBD4035/spatial_hpc/code/VistoSeg/code/logs/WS.$TASK_ID.txt
#$ -m e
...
matlab -nodesktop -nosplash -nojvm -r "addpath(genpath('$toolbox')), WS('$fname')"
