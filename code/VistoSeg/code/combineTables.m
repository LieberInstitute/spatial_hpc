...
tic
%fname =
%'/dcs04/lieber/lcolladotor/spatialHPC_LIBD4035/spatial_hpc/processed-data/Images/VistoSeg/Capture_areas/*.csv';
...
writetable(T,fullfile(myfiles(1).folder,'combined_refineVNS_metric.csv'))
