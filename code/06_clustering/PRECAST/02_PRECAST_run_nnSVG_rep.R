...
preobj = CreatePRECASTObject(seuList = seuList, selectGenesMethod=NULL,customGenelist=nnSVG_rep)
preobj@seulist
...
save(PRECASTObj, file = here("processed-data", "06_clustering", "PRECAST", paste0("allSamples_PRECASTObj_nnSVG_rep_",K,".Rdata")))
