...
preobj = CreatePRECASTObject(seuList = seuList, gene.number=2000, selectGenesMethod='SPARK-X')
preobj@seulist
...
save(PRECASTObj, file = here("processed-data", "06_clustering", "PRECAST", paste0("allSamples_PRECASTObj_sparkx_",K,".Rdata")))
