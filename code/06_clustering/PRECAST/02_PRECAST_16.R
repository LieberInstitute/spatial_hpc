...
load(file = here("processed-data", "06_clustering", "PRECAST", "stitch_PRECASTObj_16.Rdata"))
...
pdf(file = here::here("plots", "06_clustering", "PRECAST", "K16_stitch.pdf"), width = 21, height = 20)
for (i in c(1:10)){
  print(p12[[i]])
}
dev.off()
