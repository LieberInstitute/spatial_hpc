...
matlab -nodesktop -nosplash -nojvm -r "addpath(genpath('$toolbox')), O2{1} = 'DAPI'; O2{2} = 'Alexa_488'; O2{3} = 'Alexa_594'; O2{4} = 'Alexa_647'; O2{5} = 'Autofluorescence'; InFormStitch('$path2',O2,6,'$filename2')"
