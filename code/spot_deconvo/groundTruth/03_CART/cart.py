...
df_path = pyhere.here('processed-data', 'spot_deconvo', 'groundtruth', '02_samui_manual_annotation', '{}', 'df.csv')

predictions_path = pyhere.here('processed-data', 'spot_deconvo', 'groundtruth', '03_CART', 'model_predictions.csv')

dataset_path = pyhere.here('processed-data', 'spot_deconvo', '02_cellpose', 'annotation_dataset.pkl')
...
sample_info_path = pyhere.here('raw-data', 'sample_info', 'Visium_IF_DLPFC_MasterExcel_01262022.xlsx')
