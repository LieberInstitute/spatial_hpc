...
#  Paths
sce_in <- "/dcs04/lieber/lcolladotor/spatialHPC_LIBD4035/spatial_hpc/cellranger-arc-hippo/cellranger-arc-hippo/snRNAseq_hpc/processed-data/sce/sce_nmf_final.rda"
#spe_IF_in <- here("processed-data", "02_build_spe", "spe_nmf_final.rda")
spe_HE_in <- here("processed-data", "rdata", "spe", "01_build_spe","spe_filtered_final_with_clusters.Rdata")
