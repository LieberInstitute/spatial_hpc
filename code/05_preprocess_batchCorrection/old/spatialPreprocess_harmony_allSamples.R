...
# UMAP plots
pdf(file = here::here("plots", "05_preprocess_batchCorrection", "spatialPreprocess_UMAP_allSamples.pdf"))
ggplot(
...
pdf(file = here::here("plots", "05_preprocess_batchCorrection", "spatialPreprocess_UMAP_harmony_allSamples.pdf"))
ggplot(
...
save(spe, file = here::here("processed-data", "05_preprocess_batchCorrection", "spatialPreprocess_harmony_spe_allSamples.Rdata"))
