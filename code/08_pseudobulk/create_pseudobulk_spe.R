...
spe_pseudo_brain <- spe_pseudo[rowData(spe_pseudo)$high_expr_group_brain, ]
dim(spe_pseudo_brain)
...
# Plot PCA
pdf(file = here::here("plots","08_pseudobulk", "pseudobulk_PCA_BayesSpace11.pdf"), width = 14, height = 14)
...
# save RDS file
save(spe_pseudo, file = here::here("processed-data", "08_pseudobulk", "spe_pseudo_BayesSpace11.Rdata"))
