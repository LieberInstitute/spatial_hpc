...
var_oi <- "mbkmeans"
covars <- c("age")
mat_formula <- eval(str2expression(paste("~", var_oi, "+", paste(covars, collapse = " + "))))
...
save(eb0_list, file = here::here("processed-data", "08_pseudobulk", "mbkmeans", "DE_eb0_list_brain.Rdata"))