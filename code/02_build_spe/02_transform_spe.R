...
## arrange by slide_array (A1, B1, C1, D1)
spe <- arrange(spe, slide, array)
unique(spe$sample_id)
# [1] "V10B01-085_A1" "V10B01-085_B1" "V10B01-085_C1" "V10B01-085_D1"
# [5] "V10B01-086_A1" "V10B01-086_B1" "V10B01-086_C1" "V10B01-086_D1"
# [9] "V11A20-297_A1" "V11A20-297_B1" "V11A20-297_C1" "V11A20-297_D1"
# [13] "V11L05-333_A1" "V11L05-333_B1" "V11L05-333_C1" "V11L05-333_D1"
# [17] "V11L05-335_A1" "V11L05-335_B1" "V11L05-335_C1" "V11L05-335_D1"
# [21] "V11L05-336_A1" "V11L05-336_B1" "V11L05-336_C1" "V11L05-336_D1"
# [25] "V11U08-081_A1" "V11U08-081_B1" "V11U08-081_C1" "V11U08-081_D1"
# [29] "V11U08-084_A1" "V11U08-084_B1" "V11U08-084_C1" "V11U08-084_D1"

spe$position <- factor(spe$position, levels = c("TL", "TR", "BL", "BR"))

## now arrange() to get the correct order
spe <- arrange(spe, brnum, position)
