...
## load data
load(file = here::here("processed-data", "preprocessEDA", "spe_modify.Rdata"), verbose = TRUE)
...
k = 17
  ...
  pdf(here("plots",  "preprocessEDA", paste0("mbkmeans_", k, ".pdf")), width = 21, height = 20)
