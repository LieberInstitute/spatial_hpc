...
The spatially-resolved transcriptomics (SRT) and single-nucleus RNA-sequencing (snRNA-seq) data can also be accessed through the bioconductor package at [humanHippocampus2024](https://github.com/christinehou11/humanHippocampus2024](https://bioconductor.org/packages/devel/data/experiment/html/humanHippocampus2024.html)
## Contact
